    ...
    return (
        <div className={styles.slider}>
            <div className={`${styles.slide} ${styles.fadeState}`} 
                style={{ backgroundImage: `url(${reviews[slide].image}), url(${reviews[slide].image2}), url(${reviews[slide].image3}), url(${reviews[slide].image4})` , transitionDuration: `${FADE_DURATION}ms` }}
            ...
            <div className={styles.textBlock}>
                ...
                <div className={styles.sliderButtons}>
                    {slide > -1 && <button className={styles.previous} onClick={() => handlerClick(-1)}>
